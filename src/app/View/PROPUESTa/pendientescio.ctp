<ul class="breadcrumb">
  ...
  <li class="active">Pendientes de valoración del CIO<span class="divider">/</span></li>
</ul>
...
if (count($pROPUESTa) > 0) {
	...
	<tr class="<?=$colores[$pROPUESTum['PROPUESTum']['estado']]?>">
		...
		<td class="actions">
			<a href="/PROPUESTa/valorarcio/<?=$pROPUESTum['PROPUESTum']['id']?>" class="btn btn-inverse">Valorar</a>		
		</td>
	</tr>
<?php endforeach; ?>
<tr>
