...
<div class="pROPUESTa index">
	<div class="row-fluid">
		...
		<div class="span1">
			<div class="btn-group">
		  		...
		  		<ul class="dropdown-menu">
					...
					<li><?php echo $this->Html->link(__('Crear propuesta'), array('action' => 'crear')); ?></li>
					<li><?php echo $this->Html->link(__('Mis propuestas'), array('action' => 'mispropuestas')); ?></li>
					<li><?php echo $this->Html->link(__('Mis propuestas'), array('action' => 'Valorar Propuestas')); ?></li>
		...
		<!--<li><?php echo $this->Html->link(__('A&ntilde; objetivo táctico'), array('controller' => 'o_b_j_e_t_i_v_o_t_a_c_t_i_c_os', 'action' => 'add')); ?> </li>-->
				</ul>
		  	</div>
		</div>
	</div>
