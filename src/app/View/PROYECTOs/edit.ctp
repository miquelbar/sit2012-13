			...
			<div class="span1">
				<div class="btn-group">
			  		...
			  		<ul class="dropdown-menu">
						<li><?php echo $this->Form->postLink(__('Eliminar Proyecto'), array('action' => 'delete', $this->Form->value('PROYECTO.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('PROYECTO.id'))); ?></li>
